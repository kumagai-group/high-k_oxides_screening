...
def main():
    ...
    parser.add_argument('--min_epoch', type=int, default=0, help='early epochs to enforce model checkpointing')
    parser.add_argument('--es_count', type=int, default=100)
    parser.add_argument('--init_lr', type=float, default=4e-2)
    parser.add_argument('--gamma', type=float, default=0.90, help='ratio for lr decay')
